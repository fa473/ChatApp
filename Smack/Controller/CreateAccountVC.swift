...
class CreateAccountVC: UIViewController {
    ...
    @IBAction func createAccntPressed(_ sender: Any) {
        ...
        AuthService.instance.createUser(name: name, email: email, password: pass, avatarName: self.avatarName, avatarColor: self.avatarColor, completion: { (success) in
            if success {
    ...
    func setupView() {
        ...
        emailTxt.attributedPlaceholder =
            NSAttributedString(string: "email",
                               attributes: [NSAttributedStringKey.foregroundColor: smackPurplePlaceholder])
        passTxt.attributedPlaceholder =
